...
public record ResponseMappingConfig(String output, String metadata, String errorCode, String errorMessage, List<Integer> successStatusCodes,
    boolean includeRawBody) {
