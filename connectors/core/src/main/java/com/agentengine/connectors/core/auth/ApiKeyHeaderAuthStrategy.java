...
public final class ApiKeyHeaderAuthStrategy implements AuthStrategy {
    ...
    public void apply(final AuthRequestContext requestContext) {
        ...
        final String headerName = AuthTemplateUtils.resolveString(
                ...
                "headerName");
        final String apiKey = AuthTemplateUtils.resolveString(
                authConfig.apiKey(),
        ...
        requestContext
                .headers()
                .put(headerName == null || headerName.isBlank() ? DEFAULT_HEADER : headerName, apiKey.trim());
    }
}
