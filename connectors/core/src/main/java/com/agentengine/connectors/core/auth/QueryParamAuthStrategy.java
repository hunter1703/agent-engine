...
public final class QueryParamAuthStrategy implements AuthStrategy {
    ...
    public void apply(final AuthRequestContext requestContext) {
        ...
        final String paramName = AuthTemplateUtils.resolveString(
                ...
                "queryParamName");
        final String value = AuthTemplateUtils.resolveString(
                authConfig.apiKey(),
        ...
        requestContext
                .queryParams()
                .put(paramName == null || paramName.isBlank() ? DEFAULT_QUERY_PARAM : paramName, value);
    }
}
