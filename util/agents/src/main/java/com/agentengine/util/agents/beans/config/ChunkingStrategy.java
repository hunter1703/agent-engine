...
public class ChunkingStrategy {
    ...
    /**
     * Cosine similarity threshold for {@code SEMANTIC} chunking.
     * Defaults to the 25th-percentile heuristic when set to 0.
     */
    private double similarityThreshold = 0.0;

    /**
     * Maximum estimated tokens per segment fed into the LLM boundary stage.
     * Approximated as {@code chars / 3}. Defaults to 1024.
     */
