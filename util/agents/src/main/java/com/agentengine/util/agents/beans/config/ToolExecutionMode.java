...
public enum ToolExecutionMode {
  /**
   * Execute tools one at a time in the order they are requested. Use this when tools have dependent
   * side effects that must run sequentially.
   */
  SEQUENTIAL,
  ...
  /**
   * Parse a tool execution mode from a string value. Returns {@link #PARALLEL} as default for
   * null/blank/invalid values.
   */
