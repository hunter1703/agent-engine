...
public final class TemplateUtils {
    ...
    /**
     * Builds a Groovy-backed {@link Template} from a raw string, map, or list, recursing into
     * nested maps/lists so an entire config object graph (e.g. a connector spec) can be
     * templatized field-by-field and evaluated against a runtime params map. Strings containing no
     * {@code {{ }}} expression are wrapped as a constant, skipping Groovy compilation entirely.
     */
