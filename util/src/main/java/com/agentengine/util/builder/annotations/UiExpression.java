 ...
 *
 * <p>Use this annotation when the condition cannot be expressed with {@link UiRule}. The
 * {@code value} must be a valid JSONLogic JSON string that is parsed into a rule expression at
