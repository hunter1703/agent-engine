 ...
 * Methods whose return type is a {@link Publisher} (including {@link Flowable}) are mapped to a lazy stream of all responses.
 */
public class MicroServiceInvocationHandler implements InvocationHandler {
    ...
    private static final ExecutorService STREAM_EXECUTOR = Executors.newThreadPerTaskExecutor(
