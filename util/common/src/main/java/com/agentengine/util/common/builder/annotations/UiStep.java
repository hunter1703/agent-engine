 ...
 *
 * <p>A step represents a major grouping of related fields in the form. Each step can contain one
 * or more sections.
 */
@Documented
...
public @interface UiStep {
     ...
     *
     * <p>If a step has multiple sections, they will be rendered as separate groups within the
     * step. If empty or contains only one section, no section headers are shown.
     *
