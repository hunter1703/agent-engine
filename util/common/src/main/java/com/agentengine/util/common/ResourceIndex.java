...
/**
 * Represents an index of classpath resources, parsed from a simple text file (one filename per line).
 * This avoids the need for expensive and unreliable runtime classpath scanning.
 */
