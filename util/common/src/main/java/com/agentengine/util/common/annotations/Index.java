...
/**
 * Declares an index on the annotated entity, created by
 * {@link com.agentengine.util.common.repository.IndexedRepository#ensureIndexes()}.
 *
 * <p>Indexes are declared next to the entity they belong to so that a query and the index serving it
 * are read together.
 */
