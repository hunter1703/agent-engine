...
public abstract class AbstractMongoReadRepository<T extends BaseEntity> implements ReadRepository<T> {
  ...
  public AbstractMongoReadRepository(final MongoClientFactory mongoClientFactory, final String collectionName, final Class<T> entityClass) {
    this(mongoClientFactory, "AGENT_ENGINE", collectionName, entityClass);
  }

  public AbstractMongoReadRepository(final MongoClientFactory mongoClientFactory, final String databaseName, final String collectionName,
  ...
  @Override
  public Map<String, T> findByIds(final Collection<String> ids, final List<String> includeFields, final List<String> excludeFields) {
    try {
