...
public class MongoClientFactory {
  ...
  @Inject MongoClientSupport mongoClientSupport;

  @Inject Instance<EncryptionService> encryptionService;

  public MongoClient getClient() {
    final String connectionString = resolveConnectionString();
    return MongoClients.create(
        buildClientSettings(
            connectionString, getBsonDiscriminators(mongoClientSupport), encryptionService));
  }
