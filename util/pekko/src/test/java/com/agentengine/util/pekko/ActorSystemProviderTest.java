...
class ActorSystemProviderTest {
  ...
  @Test
  void shouldBuildConfigUsingSqlInfraConfigAndResolvedPodPlaceholders() {
    ...
    pekkoConfig.setSeedNodes(java.util.List.of(
    ...
    final com.typesafe.config.Config config = ActorSystemProvider.buildConfig(pekkoConfig, sqlConfig);
