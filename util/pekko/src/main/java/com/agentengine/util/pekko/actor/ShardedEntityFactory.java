 ...
 */
public abstract class ShardedEntityFactory<Command>
        implements ShardedEntity.ShardedEntityDefinition<Command, ShardingEnvelope<Command>> {
    ...
    private Entity<Command, ShardingEnvelope<Command>> buildEntity(
            final EntityTypeKey<Command> entityTypeKey,
            final Function<EntityContext<Command>, Behavior<Command>> builder,
            final Duration passivationDuration) {
