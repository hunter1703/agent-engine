 ...
 * With the subscribe-before-publish contract, this naturally co-locates broadcasters with
 * their subscribers.
 */
public final class RequesterFirstAllocationStrategy extends ShardCoordinator.AbstractShardAllocationStrategy {
    ...
    @Override
    public Future<ActorRef> allocateShard(final ActorRef requester, final String shardId, final Map<ActorRef, IndexedSeq<String>> currentShardAllocations) {
