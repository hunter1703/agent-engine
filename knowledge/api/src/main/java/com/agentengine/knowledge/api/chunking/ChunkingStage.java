 ...
 *
 * <p>Splitting stages produce new chunks from the text of each input chunk.
 * The embedding stage populates the vector on each chunk.
 *
 * <p>Implementations must be stateless — the same instance may be reused across concurrent
 * indexing operations.
 */
