 ...
 * parent that it has paused waiting for an interrupt to be resumed, or that its run has finished.
 */
public interface ChildCommand extends SessionCommand {

    /** Notifies the parent that this child has paused and is waiting for an external interrupt to be resumed. */
