 ...
 * List<SessionEvent>} reply uses {@code ImmutableCollections$ListN}, which has no registered Pekko
 * serializer and causes the ask to time out in multi-node deployments.
 */
