...
public interface ExternalCommand extends SessionCommand {
  ...
  record ResumeCommand(ResumeRequest resumeRequest, ActorRef<ResumeResult> replyTo)
      implements ExternalCommand {}
   ...
   * sequence numbers.
   */
  record GetCurrentTurnEventsCommand(ActorRef<CurrentTurnEvents> replyTo)
      implements ExternalCommand {}
   ...
   */
  record RollbackCommand(String runId, ActorRef<RollbackResult> replyTo)
      implements ExternalCommand {}
}
