 ...
 *
 * <p>These commands assume a direct parent-child relationship. A peer or unrelated session
 * has no authority to initialize, inject messages into, or query the result of another
 * session's children.
 */
public interface ParentCommand extends SessionCommand {
    ...
    record InitializeCommand(SessionTopology topology, ActorRef<Done> replyTo) implements ParentCommand {}
