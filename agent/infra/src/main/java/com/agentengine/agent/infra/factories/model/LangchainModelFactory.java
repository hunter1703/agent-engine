...
import com.agentengine.agent.infra.model.LangChain4jModel;
...
public abstract class LangchainModelFactory extends DelegatingModelFactory<BaseLlm> {
    ...
    static {
        DEFAULT_JSON_RESPONSE_FORMAT = JsonUtils.fromJson(
                ResourceUtils.loadResourceAsString("/schemas/shared/response_schema.json"), new TypeReference<>() {});
    }
    ...
    protected static JsonSchema toJsonSchema(final Map<String, Object> jsonSchemaMap) {
        return JsonSchema.builder()
                .rootElement(buildJsonSchemaElement(jsonSchemaMap))
                .build();
    }
        ...
        if (jsonSchema.containsKey("const")) {
            ...
            if (constValue != null) {
                return JsonEnumSchema.builder()
                        .enumValues(constValue.toString())
                        .build();
            }
        }
        return null;
