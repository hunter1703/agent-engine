...
public final class AddVignetteTool extends ImageEditingTool {
    ...
    public ToolOutput<Map<String, Object>> execute(
            @ToolSchema(name = "artifactName", description = "Artifact name of the input image.") String artifactName,
            @ToolSchema(
                            name = "adjustment",
                            description =
        ...
        return processImage(
                artifactName,
                inputFile -> ImageUtils.processTiled(
                        inputFile,
                        (pixels, tileX, tileY, tileW, tileH, imageW, imageH) -> ImageUtils.applyVignette(
                                pixels, tileX, tileY, tileW, tileH, imageW, imageH, adjustment)),
                toolContext);
    }
}
