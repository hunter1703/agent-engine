...
public record VignetteAdjustment(
        @ToolSchema(
                name = "amount",
                description = "Darkening or lightening of image edges, integer [-100, 100]. "
        ...
        @ToolSchema(
                name = "midpoint",
                description = "Controls how far from the image centre the vignette begins, integer [0, 100]. "
        ...
        @ToolSchema(
                name = "feather",
                description = "Softness of the transition from clear centre to vignetted edge, integer [0, 100]. "
        ...
        @ToolSchema(
                name = "saturation",
                description = "Saturation change applied at the vignette edges, integer [-100, 100]. "
