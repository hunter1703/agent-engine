...
public record ExposureAdjustment(
        @ToolSchema(
                name = "exposure",
                description = "Global exposure shift in EV (stops), real number. "
        ...
        @ToolSchema(
                name = "blacks",
                description = "Tone curve offset for the deepest shadows (0–25% luminance), integer. "
        ...
        @ToolSchema(
                name = "shadows",
                description = "Tone curve offset for dark midtones (25–50% luminance), integer. "
        ...
        @ToolSchema(
                name = "highlights",
                description = "Tone curve offset for light midtones (50–75% luminance), integer. "
        ...
        @ToolSchema(
                name = "whites",
                description = "Tone curve offset for the brightest tones (75–100% luminance), integer. "
        ...
        @ToolSchema(
                name = "saturation",
                description = "Global colour intensity shift, integer. "
