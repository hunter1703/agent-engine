...
public record SplitToneAdjustment(
        @ToolSchema(
                name = "shadow_hue",
                description = "Hue of the colour tint applied to dark/shadow areas, in degrees [0, 360). "
        ...
        @ToolSchema(
                ...
                description = "Strength of the shadow colour tint, integer [0, 100]. "
        ...
        @ToolSchema(
                name = "highlight_hue",
                description = "Hue of the colour tint applied to bright/highlight areas, in degrees [0, 360). "
        ...
        @ToolSchema(
                ...
                description = "Strength of the highlight colour tint, integer [0, 100]. "
