...
/**
 * White balance adjustment using industry-standard Kelvin temperature and integer tint, matching
 * Lightroom/Camera Raw XMP fields {@code crs:Temperature} and {@code crs:Tint}.
 *
