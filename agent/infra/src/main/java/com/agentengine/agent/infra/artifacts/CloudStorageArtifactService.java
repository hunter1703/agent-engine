...
public class CloudStorageArtifactService implements BaseArtifactService {
                              ...
                              .orElseThrow(
                                  () ->
                                      new IllegalArgumentException(
                                          "Artifact data must not be empty."));
            ...
            versions -> {
              ...
              return Completable.fromAction(
                  () ->
                      versions.forEach(
                          v ->
                              cloudStorageService.delete(
                                  objectKey(appName, userId, sessionId, filename, v))));
            });
  }
  ...
  /**
   * Collects filenames from keys under {@code prefix}. Session keys: {@code
   * appName/userId/sessionId/filename/version} — filename at index 3. User keys: {@code
   * appName/user/userId/filename/version} — filename at index 3.
   */
