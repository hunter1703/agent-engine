...
/**
 * A single hue-targeted color adjustment, equivalent to one color channel in Lightroom's HSL/Color
 * Mix panel (crs:HueAdjustmentRed, crs:SaturationAdjustmentRed, etc.) but with explicit hue
 * targeting by center and width rather than fixed color buckets.
 *
 * <p>hue_shift is in degrees (not Lightroom's -100/+100 UI scale) because degrees are unambiguous
 * and model-friendly: the model can reason "shift reds 30° toward orange" without needing to know
 * Lightroom's internal mapping.
 *
