...
public record ColorAdjustment(
        @ToolSchema(
                name = "hue_center",
                description = "Center hue of the targeted range in degrees. "
        ...
        @ToolSchema(
                name = "hue_width",
                description = "Half-width of the targeted hue range in degrees. "
        ...
        @ToolSchema(
                name = "hue_shift",
                description = "Degrees to rotate the hue of affected pixels along the colour wheel. "
        ...
        @ToolSchema(
                name = "sat_delta",
                description = "Saturation change for targeted pixels, integer [-100, 100]. "
        ...
        @ToolSchema(
                name = "lum_delta",
                description = "Luminance (brightness) change for targeted pixels, integer [-100, 100]. "
