...
import com.agentengine.runtime.tools.echo.EchoTool;
import com.agentengine.runtime.tools.file.ReadFileTool;
import com.agentengine.runtime.tools.DiscoveredToolProviders.ToolParameter;
...
class DiscoveredToolProvidersTest {
  ...
  void shouldPopulateConfigsSchemaFromConstructorAnnotationsWhenToolIsDiscoverable() throws NoSuchMethodException {
    ...
    final Map<String, Object> properties = (Map<String, Object>) descriptor.configsSchema().get("properties");
    @SuppressWarnings("unchecked")
