...
public final class ParallelOrchestrationConstants {
  ...
  public static final class Message {
    public static final String EMPTY_RESULT = "Parallel orchestration completed without a successful textual result.";
    public static final String FALLBACK = "Parallel stopping target was not met; applied deterministic best-effort fallback.";
