...
public final class CreatePlanTool extends Tool {
  ...
  public static final ToolDescriptor DESCRIPTOR = new ToolDescriptor(TOOL_NAME,
      "Create a new plan with a list of tasks. Use 'parent_id' for logical hierarchy.", Map.of());
  ...
  public Map<String, Object> execute(
    ...
    return Map.of("status", "Success. Plan '" + title + "' has been created and saved with " + tasks.size() + " tasks. ");
  }
}
