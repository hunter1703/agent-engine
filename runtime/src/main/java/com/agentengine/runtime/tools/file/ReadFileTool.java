 ...
 * line ranges with configurable offset and limit. Returns content hash for
 * patch validation.
 */
@DiscoverableTool
public final class ReadFileTool extends BaseFileTool {
  ...
  public Map<String, Object> execute(
      @ToolSchema(name = "file_path", description = "Absolute or relative path to the file to read") String filePath,
      @ToolSchema(name = "offset", description = "0-indexed line number to start reading from (default: 0)", optional = true) Integer offset,
      @ToolSchema(name = "limit", description = "Maximum number of lines to return (default: 50)", optional = true) Integer limit) {
