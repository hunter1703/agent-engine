...
/**
 * Exposure and tone adjustments matching Lightroom/Camera Raw Process Version 2012 (PV2012)
 * XMP fields: {@code crs:Exposure2012}, {@code crs:Blacks2012}, {@code crs:Shadows2012},
 * {@code crs:Highlights2012}, {@code crs:Whites2012}, {@code crs:Saturation}.
 *
 * <p>Editing order within this tool: exposure → tone curve (blacks/shadows/highlights/whites) → saturation.
 *
 * <p>Tone curve zones (linear luminance ranges):
 * <ul>
 *   <li>{@code blacks}     — deepest shadows, 0–25% luminance</li>
 *   <li>{@code shadows}    — dark midtones, 25–50% luminance</li>
 *   <li>{@code highlights} — light midtones, 50–75% luminance</li>
 *   <li>{@code whites}     — brightest tones, 75–100% luminance</li>
 * </ul>
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public record ExposureAdjustment(
        @ToolSchema(name = "exposure", description = "Global exposure shift in EV (stops), real number. "
                ...
                + "Range: -5.0 to +5.0; 0.0 = no change.", optional = true)
        @JsonProperty("exposure")
        double exposure,

        @ToolSchema(name = "blacks", description = "Tone curve offset for the deepest shadows (0–25% luminance), integer. "
                ...
                + "Range: -100 to +100; 0 = no change.", optional = true)
        @JsonProperty("blacks")
        int blacks,

        @ToolSchema(name = "shadows", description = "Tone curve offset for dark midtones (25–50% luminance), integer. "
        ...
        @ToolSchema(name = "highlights", description = "Tone curve offset for light midtones (50–75% luminance), integer. "
        ...
        @ToolSchema(name = "whites", description = "Tone curve offset for the brightest tones (75–100% luminance), integer. "
        ...
        @ToolSchema(name = "saturation", description = "Global colour intensity shift, integer. "
