 ...
 * Matches Lightroom's Color Grading panel XMP fields:
 * {@code crs:ColorGradingShadowHue}, {@code crs:ColorGradingShadowSat},
 * {@code crs:ColorGradingHighlightHue}, {@code crs:ColorGradingHighlightSat},
 * {@code crs:ColorGradingBalance}.
 *
...
public record SplitToneAdjustment(
        @ToolSchema(name = "shadow_hue", description = "Hue of the colour tint applied to dark/shadow areas, in degrees [0, 360). "
                ...
                + "30–60 (amber/warm shadows) for a vintage/sepia look.", optional = true)
        @JsonProperty("shadow_hue")
        double shadowHue,

        @ToolSchema(name = "shadow_saturation", description = "Strength of the shadow colour tint, integer [0, 100]. "
                ...
                + "60–80 = strong stylized look. 100 = maximum tint.", optional = true)
        @JsonProperty("shadow_saturation")
        int shadowSaturation,

        @ToolSchema(name = "highlight_hue", description = "Hue of the colour tint applied to bright/highlight areas, in degrees [0, 360). "
                ...
                + "0–15 (warm red/rose) for a romantic/vintage look.", optional = true)
        @JsonProperty("highlight_hue")
        double highlightHue,

        @ToolSchema(name = "highlight_saturation", description = "Strength of the highlight colour tint, integer [0, 100]. "
        ...
        @ToolSchema(name = "balance", description = "Shifts the luminance crossover point between shadows and highlights, integer [-100, 100]. "
                ...
                + "Typical use: ±10 to ±30 for fine-tuning; leave at 0 for a balanced grade.", optional = true)
