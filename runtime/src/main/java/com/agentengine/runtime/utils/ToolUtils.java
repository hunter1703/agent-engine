...
public final class ToolUtils {
  ...
  public static String agentId(final ToolContext toolContext) {
    if (toolContext == null || toolContext.invocationContext() == null || toolContext.invocationContext().agent() == null
  ...
  public static String sessionId(final ToolContext toolContext) {
    if (toolContext == null || toolContext.invocationContext() == null || toolContext.invocationContext().session() == null
