...
public final class SessionUtils {
    ...
    private static SessionPause buildPauseView(final FunctionCall confirmationCall, final String confirmationId) {
        final Map<String, Object> args =
                CollectionUtils.nullSafeMap(confirmationCall.args().orElse(Map.of()));
        final FunctionCall originalCall = Utils.toType(
    ...
    private static SessionPauseKind resolveKind(final String toolName, final Map<String, Object> payload) {
        ...
        return SessionPauseKind.valueOfOrDefault(
                CollectionUtils.getStringValueFromMap(payload, HumanInTheLoopTool.KIND));
    }
