...
public interface ExternalCommand extends SessionCommand {
    ...
    record StartChildCommand(String agentId, String message, ActorRef<StartChildResult> replyTo)
            implements ExternalCommand {}

    record SendMessageCommand(String sessionId, String message, ActorRef<StartSessionResult> replyTo)
            implements ExternalCommand {}

    record ResumeCommand(String confirmationId, Boolean confirmed, String answer, ActorRef<ResumeResult> replyTo)
            implements ExternalCommand {}
