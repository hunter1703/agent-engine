...
public record SessionState(
    ...
    public SessionState withExecution(final ExecutionState execution) {
        return new SessionState(topology, execution, queue, childRegistry, nextSequence);
    }

    public SessionState withQueue(final MessageQueue queue) {
        return new SessionState(topology, execution, queue, childRegistry, nextSequence);
    }
