...
public class SchemaAndCatalogEndpointsIT {
  ...
  @Inject private AgentSessionRepository agentSessionRepository;
  ...
  public void shouldListSessionsWhenCatalogListEndpointCalledWithoutPage() {
    agentSessionRepository
        .createSession("agent-catalog", "default", new ConcurrentHashMap<>(), "session-catalog-1")
        .blockingGet();
  ...
  public void shouldReturnAgentWhenCatalogSearchFiltersById() {
    given()
        ...
        .statusCode(200)
        .body("items.size()", greaterThanOrEqualTo(1))
        .body("items[0].id", Matchers.equalTo("agent-catalog"))
