...
public class ExtractMessageFromInputTest {
  ...
  public void testExtractLatestUserMessage() {
    ...
    ResponsesApiRequest.InputMessage inputMessage1 = new ResponsesApiRequest.InputMessage("message", "user",
        contentParts1);
    ResponsesApiRequest.InputMessage inputMessage2 = new ResponsesApiRequest.InputMessage("message", "assistant",
        contentParts2); // Assistant message
    ResponsesApiRequest.InputMessage inputMessage3 = new ResponsesApiRequest.InputMessage("message", "user",
        contentParts3); // Latest user message
  ...
  public void testReturnEmptyWhenNoUserMessages() {
    ResponsesApiRequest.ContentPart contentPart = new ResponsesApiRequest.ContentPart("input_text",
        "Assistant message");
    List<ResponsesApiRequest.ContentPart> contentParts = Arrays.asList(contentPart);
    ResponsesApiRequest.InputMessage inputMessage = new ResponsesApiRequest.InputMessage("message", "assistant",
        contentParts);
