...
@Schema(
    ...
    discriminatorMapping = {
      ...
      @DiscriminatorMapping(
          ...
          schema = OutputTextDeltaEventData.class),
      @DiscriminatorMapping(
          value = "response.output_item.added",
          schema = OutputItemAddedEventData.class),
      @DiscriminatorMapping(
          value = "response.output_item.done",
          schema = OutputItemDoneEventData.class),
      @DiscriminatorMapping(
          value = "response.reasoning_summary_part.added",
          schema = ReasoningSummaryPartAddedEventData.class),
      @DiscriminatorMapping(
          value = "response.reasoning_summary_text.delta",
          schema = ReasoningSummaryTextDeltaEventData.class),
