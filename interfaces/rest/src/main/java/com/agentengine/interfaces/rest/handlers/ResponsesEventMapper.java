...
public final class ResponsesEventMapper {
    ...
    private Flowable<ResponseOutputEvent> outputItemDone(String itemType) {
        return Flowable.just(
                new ResponseOutputEvent("response.output_item.done", null, null, null, outputIndex - 1, itemType));
    }
    ...
    private Flowable<ResponseOutputEvent> toolCallArgumentsDelta(String toolCallId, String arguments) {
        return Flowable.just(new ResponseOutputEvent(
                "response.function_call.arguments.delta", arguments, null, null, null, null, toolCallId, null));
    }
    ...
    private Flowable<ResponseOutputEvent> toolResultAdded(String toolCallId, String result) {
        int index = outputIndex++;
        return Flowable.just(new ResponseOutputEvent(
                "response.tool_call.output_item.added", result, null, null, index, "tool_call", toolCallId, null));
    }
    ...
    public record ResponseOutputEvent(
        ...
        public ResponseOutputEvent(
                String type, String delta, String finishReason, Usage usage, Integer outputIndex, String itemType) {
