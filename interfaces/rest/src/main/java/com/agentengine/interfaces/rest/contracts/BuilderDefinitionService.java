package com.agentengine.interfaces.rest.contracts;
...
public class BuilderDefinitionService {
  ...
  private BuilderDefinition generateDefinition(final String assetType) {
    return switch (assetType) {
      case "agent" -> BuilderDefinitionUtils.generate("agent", BaseAgentConfig.class);
      case "model" -> BuilderDefinitionUtils.generate("model", ModelConfig.class);
