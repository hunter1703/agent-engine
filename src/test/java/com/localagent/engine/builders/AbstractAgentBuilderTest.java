...
class AbstractAgentBuilderTest {
    ...
    void buildJsonSchemaElementHandlesObjectsArraysEnumsAndNullable() {
        Map<String, Object> objectSchema = Map.of(
                "type",
                "object",
                "properties",
    ...
    void buildJsonSchemaElementSupportsAnyOfAndConst() {
        Map<String, Object> anyOfSchema = Map.of(
                "anyOf",
    ...
    void buildContextBuildersUseLastNConfig() {
        ...
        assertThat(reasoning).isInstanceOf(com.localagent.engine.context.LastNContextBuilder.class);
    ...
    private static final class TestAgentBuilder extends AbstractAgentBuilder {
        ...
        private ContextBuilder callBuildReasoningContextBuilder(
                ...
                final List<com.localagent.engine.tools.AgentTool> tools) {
        ...
        @Override
        public com.localagent.engine.AgentEngine build(
                String agentName, com.localagent.engine.beans.config.AgentConfig agentConfig) {
            return null;
        }
