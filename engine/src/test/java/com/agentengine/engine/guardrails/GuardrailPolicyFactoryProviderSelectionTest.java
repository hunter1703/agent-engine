...
class GuardrailPolicyFactoryProviderSelectionTest {

  @Test
  void routesRuleToMatchingProvider() {
    final GuardrailPolicyFactory registry = new GuardrailPolicyFactory(List.of(new TextContentGuardrailProvider()));
