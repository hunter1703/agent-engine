...
//      final ToolRegistry toolRegistry, final SessionServiceProvider sessionServiceProvider,
//      final MessageStoreProvider messageStoreProvider) {
//    super(modelProvider, sessionServiceProvider, toolRegistry);
...
//
//    final SessionStore sessionStore = sessionServiceProvider.get(agentConfig.getSessionStore());
