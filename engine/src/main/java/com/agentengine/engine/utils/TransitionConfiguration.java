...
public final class TransitionConfiguration<S, T, V> extends com.github.oxo42.stateless4j.StateConfiguration<S, T> {
  private final Map<T, Supplier<V>> invalidHandlers = new HashMap<>();

  TransitionConfiguration(final StateMachineConfiguration<S, T, V> parent, final S state) {
