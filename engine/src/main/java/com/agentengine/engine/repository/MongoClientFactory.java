...
public final class MongoClientFactory {
  ...
  public static MongoClient createClient(final MongoClientSupport mongoClientSupport, String connectionString) {
    connectionString = StringUtils.isNotBlank(connectionString) ? connectionString : resolveConnectionString();
    return MongoClients.create(buildClientSettings(connectionString, getBsonDiscriminators(mongoClientSupport)));
  }
  ...
  private static MongoClientSettings buildClientSettings(final String connectionStringStr,
