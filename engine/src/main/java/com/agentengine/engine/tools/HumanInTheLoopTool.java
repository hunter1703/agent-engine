...
public final class HumanInTheLoopTool extends Tool {
  ...
  public Map<String, Object> execute(
      ...
      @ToolSchema(
              name = ARG_CONTEXT,
              description = "Optional context metadata for the pause",
              optional = true)
          final Map<String, Object> context) {
    if (toolContext == null) {
      return Map.of(
              "status", STATUS_ERROR,
              "message", "Invocation context is not available for request_human_input.");
    }
  ...
  private static List<String> sanitizeOptions(
      final List<String> options, final SessionPauseKind pauseKind) {
