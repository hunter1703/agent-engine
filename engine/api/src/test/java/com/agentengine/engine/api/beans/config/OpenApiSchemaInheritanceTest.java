...
class OpenApiSchemaInheritanceTest {
  ...
  void sessionServiceConfigDefinesDiscriminatorMappings() {
    ...
    assertThat(schema.oneOf())
        .contains(InMemorySessionServiceConfig.class, MongoSessionServiceConfig.class);
    ...
    assertThat(schema.discriminatorMapping())
        ...
        .containsExactlyInAnyOrder(
            InMemorySessionServiceConfig.class, MongoSessionServiceConfig.class);
  }
