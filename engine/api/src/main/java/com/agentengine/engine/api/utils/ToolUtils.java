...
public final class ToolUtils {
    ...
    public static FunctionDeclaration buildFunctionDeclaration(final Method method, final ToolDescriptor toolDescriptor) {
        final FunctionDeclaration.Builder builder = FunctionDeclaration.builder().name(toolDescriptor.name()).description(toolDescriptor.description());
    ...
    private static Schema buildSchemaRecursive(final JavaType javaType, final SchemaContext context) {
        ...
        try {
            ...
            } else if (Integer.class.equals(rawClass) || int.class.equals(rawClass) || Long.class.equals(rawClass) || long.class.equals(rawClass)) {
                builder.type("INTEGER");
            } else if (Double.class.equals(rawClass) || double.class.equals(rawClass) || Float.class.equals(rawClass) || float.class.equals(rawClass)) {
                builder.type("NUMBER");
    ...
    private static Schema applyFieldMetadata(final Schema schema, final ToolSchema toolSchema, final boolean required, final List<String> enumValues) {
